...
{
    public Powers_GuardianController moveScript;
    ...
    void Start()
    {
        offset = transform.position - moveScript.transform.position;
    ...
    void Update()
    {
        ...
        transform.position = moveScript.transform.position + offset;
    ...
    private void ZoomCamera()
    {
        ...
        if (moveScript.moveSpeed > moveScript.walkSpeed) cam.fieldOfView = Powers_AnimMath.Slide(cam.fieldOfView, 75, 0.1f);
        else cam.fieldOfView = Powers_AnimMath.Slide(cam.fieldOfView, 70, 0.1f);
    }
